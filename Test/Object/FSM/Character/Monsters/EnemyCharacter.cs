...
namespace Test.FSM.Character.Monsters
{
    //YOON : 추후 GameObject 받으면 상속필요
    class EnemyCharacter : Character
    {
        public string GetName() => stat.Name;
        public EnemyCharacter(Stat stat) : base(stat)
        {
            this.stat = stat;
        ...
        public void AttackPlayer(PlayerData data)
        {
            ...
            data.HealthPoint -= (stat.AttackDamage);
        }
    ...
    class BossEnemyCharacter : EnemyCharacter
    {
        ...
        public BossEnemyCharacter(Stat stat) : base(stat)
        {
            this.stat = stat;
            stateMachine = new MonsterStateMachine(stat);
